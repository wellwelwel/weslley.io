...
> [!TIP]
>
> - Use the [**GitHub Pages**](https://pages.github.com/) to serve your website for free
> - Use your own colors and assets (images, icons, etc.) to make your site unique ✨

> [!IMPORTANT]
> Please be careful not to misuse the [**AGPL-3.0 License**](https://github.com/wellwelwel/weslley.io/blob/main/LICENSE) and [**Creative Commons License**](https://github.com/wellwelwel/weslley.io/blob/main/LICENSE-assets).
>
