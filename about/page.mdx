...
🚀 Contribuo ativamente em diversos projetos de alto impacto que, juntos,
somam mais de **550 milhões de downloads mensais**. Alguns
deles são:
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          <i>
            (created under{' '}
            <SafeLink to='https://github.com/mysqljs'>mysqljs</SafeLink>{' '}
            organization)
          </i>
          .
        </td>
...
🐬 Tenho orgulho de ser co-mantenedor do **MySQL2**, o driver **MySQL** mais performático e baixado para **Node.js**
, **Bun** e **Deno**, utilizado por <SafeLink to='https://github.com/sidorares/node-mysql2/network/dependents'>
mais de 880 mil projetos públicos</SafeLink> no **GitHub**.

---

## Poku

🐷 Também sou o criador do <SafeLink to='https://github.com/wellwelwel/poku'>Poku</SafeLink>, um executor
de testes de alta performance que simplifica a forma como você testa seu
código com **JavaScript**.
...
Estou sempre disposto a discutir maneiras criativas de tornar a vida dos
desenvolvedores mais fácil e segura.
