...
📹 **Palestra:** Criando um Test Runner: O que acontece por trás dos testes?
...
Nessa palestra, eu desmonto o Poku, o único _test runner_ brasileiro para **JavaScript** e **TypeScript**, que desafia mais de 12 anos da história da linguagem, ao trazer a sintaxe nativa do **JavaScript** para os testes.
...
**Data da Palestra:** 19 de julho de 2025.<br />
**Local:** Viasoft Experience, Curitiba - PR.

Programação completa do evento: [codecon.dev/summit/programacao](https://codecon.dev/summit/programacao).
