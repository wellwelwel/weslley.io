...
const Poku = () => (
  ...
  >
    <p>
      ...
      isso. Então surgiu uma ideia:{' '}
      <strong>E se eu tornasse os testes fáceis?</strong>
    </p>
    <p>
      Como resultado, surgiu um <em>test runner</em> com zero configurações e
      que vai nas origens do <strong>JavaScript</strong> e traz de volta a
      sintaxe nativa para os testes, performando até{' '}
      ...
      ecossistema <strong>JavaScript</strong> em testes simples.
    </p>
  </Project>
);
