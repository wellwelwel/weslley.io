...
export const slots: Slot[] = [
  {
    ...
    talk: 'microsoft-reactor-e-nodebr',
  ...
  },
  {
    ...
    talk: 'devfest-cerrado-google-developer-groups-gdg',
    venue: 'Goiânia, GO',
    address:
  ...
  },
  {
    ...
    talk: 'github-brasil-open-source-friday',
    coupon: { code: 'Gratuito' },
    venue: 'Online',
  ...
  },
  {
    ...
    talk: 'winx-day-luciano-dii-souza-o-primo-dev',
    coupon: { code: 'Gratuito' },
    venue: 'Online',
    title:
      'Superando a síndrome do impostor e os desafios de existir no mercado através do open source',
  ...
  },
  {
    ...
    logo: '/img/dcl.png',
    talk: 'devconverge-latam-26-oracle-sprint-sp',
  ...
  },
  {
    ...
    logo: '/img/ssi.png',
    talk: 'semana-de-sistemas-de-informacao-each-usp',
  ...
  },
  {
    ...
    event: 'DevFest Cerrado (GDG)',
    logo: '/img/devfest-cerrado.png',
    talk: 'devfest-cerrado-google-developer-groups-gdg-2025',
  ...
  },
  {
    ...
    event: 'DevFest Cerrado (GDG)',
    logo: '/img/devfest-cerrado.png',
    talk: 'devfest-cerrado-google-developer-groups-gdg-mentoria-2025',
    url: 'https://doity.com.br/dfc25',
    material: 'https://github.com/wellwelwel/devfest-cerrado-2025',
    venue: 'Goiânia, GO',
    address:
